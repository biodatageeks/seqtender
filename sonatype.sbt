...
sonatypeProjectHosting := Some(GitHubHosting("biodatageeks", "seqtender", "team@biodatageeks.org"))
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/biodatageeks/seqtender"),
    "scm:git@github.com:biodatageeks/seqtender.git"
  )
)
developers := List(
